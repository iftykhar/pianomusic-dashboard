...
interface ModuleDeleteConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isLoading: boolean;
...
const ModuleDeleteConfirmModal: React.FC<ModuleDeleteConfirmModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
        ...
        <div className="bg-linear-to-br from-rose-500 to-rose-600 p-8 text-white flex flex-col items-center text-center">
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-rose-100 font-medium">
              ...
              <span className="font-bold underline">{title}</span>. This action
              cannot be undone.
            </DialogDescription>
          </DialogHeader>
        </div>
...
export default ModuleDeleteConfirmModal;
